...
class User(db.Model):
    ...
    def __repr__(self):
        return f'<User user_id={self.user_id} email={self.email} username={self.username} name={self.name} location={self.location} about={self.about} member_since={self.member_since}'
...
class Ingredient(db.Model):
    ...
    def __repr__(self):
        return f'<Ingredient ingredient_id={self.ingredient_id} food_data_id={self.food_data_id} name={self.name} calories={self.calories}, measurement={self.measurement}, photo={self.photo}>'
